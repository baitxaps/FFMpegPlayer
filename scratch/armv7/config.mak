...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode' --extra-ldflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode' --prefix=/Users/rhc/Desktop/FFmpeg-iOS-build-script-master/thin/armv7
prefix=/Users/rhc/Desktop/FFmpeg-iOS-build-script-master/thin/armv7
